...
export const composableABI: any = [
  {
    inputs: [
      ...
      },
      {
        ...
        name: '_numDefaultLayers',
        type: 'uint256',
      },
      {
        internalType: 'string',
        name: '_specialMintIpfsUri',
        type: 'string',
      },
      {
